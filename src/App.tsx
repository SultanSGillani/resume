...
import type { ResumeData, ResumeProfile, ResumeWork } from "./types";
...
function getDuration(item: ResumeWork): string {
...
function profileLabel(profile: ResumeProfile): string {
